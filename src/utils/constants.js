const GOOGLE_API_KEY = "AIzaSyBofB_EDdl-XHQKpLlSD33gf7EDmrHQHgc";
...
const VIDEO_BY_ID = `https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&id=&key=${GOOGLE_API_KEY}`;

export const OFFSET_LIVE_CHAT=50;

export const getVideoInfoByID = async (videoid) => {
...
export const getSearchResultsPageList = async (searchText) => {
  const info = await fetch(
...
export function randomTextGenerator(length) {
  let result = '';
